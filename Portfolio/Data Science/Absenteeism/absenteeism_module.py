...
#create the special class used from here on out to predict new data
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # to preserve the code a column with 'NaN; strings is used
            ...
            # used to call the 'preprocessed data'
            self.preprocessed_data = df.copy()
            
            # line used for the next functions
